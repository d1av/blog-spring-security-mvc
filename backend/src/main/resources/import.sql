...
INSERT INTO Comments(name,email,body,post_id) VALUES ('Comment 1','john@cena','First Comment',1);
INSERT INTO Comments(name,email,body,post_id) VALUES ('Nearly first :(','john@cena','Close',1);
INSERT INTO Comments(name,email,body,post_id) VALUES ('Comment 1','tony@stark','First Comment',2);
INSERT INTO Comments(name,email,body,post_id) VALUES ('Nearly First','john@cena','Close',2);
